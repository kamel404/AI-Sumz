...
const Demo = () => {
  ...
  const handeSubmit = async(e) => {
    ...
    if(data ?.summary){
      ...
      const UpdatedAlArticles = [newArticle, ...allArticles];
      setArticle(newArticle);
      setAllArticles(UpdatedAlArticles);  
      console.log(newArticle);
      localStorage.setItem('articles', JSON.stringify(UpdatedAlArticles));
    }
  }
  ...
  return (
    <section className="mt-16 w-full max-w-xl">
      ...
      <div className="flex-col w-full gap-2">
        <form className="relative flex justify-center items-center" onSubmit={handeSubmit}>
      ...
      <div className="my-10 max-w-full flex justify-center items-center">
          {isFetching ? (<img src={loader} alt="spinnig_load" className="w-20 h-20 object-contain"/>): error ? (
            <p className="font-inter font-bold text-black text-center">
              Well, that was'nt supposed to happen...
              <br/>
